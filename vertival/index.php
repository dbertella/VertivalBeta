<?php get_header(); ?>
		<div class="next_button"><img src="<?php bloginfo('template_directory');?>/img/next.png" /></div>
		<div class="prev_button"><img src="<?php bloginfo('template_directory');?>/img/prev.png" /></div>
		<?php 
		$query = new WP_Query( array( 'post_type' => 'slide', 'orderby' => 'title', 'order' => 'ASC' ) );
		...
		?>
			...
			<?php 
				...
				$description_img = get_post_meta($post->ID, 'vt_description_img', TRUE); 
			...
			<?php elseif($description_title!='' || $description_txt!='') : // Testo slide ?>
				...
				<?php $image = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), '' ); ?>
					<div class="slide blocco t_text" id="post-<?php the_ID(); ?>" style="background-image: url('<?php echo $image[0]; ?>')">
						<div class="filtro">							
				<?php else : // Slide senza feautured background ?>	
					<div class="slide blocco t_text" id="post-<?php the_ID(); ?>">
						<div class="no-filtro">
				<?php endif; ?>
							<table width="100%" border="0" cellpadding="0" cellspacing="0" >
								<tr>
									<td align="center">
										...
										<?php if ($description_img != ''): // simple check about the image?>
											<div class="pic_slide" style="background-image: url('<?php echo $description_img; ?>')"></div>
											<div class="animate-in" data-animation="fly-in-left"><?php echo htmlspecialchars_decode($description_txt); ?></div>
										<?php else: ?>
											<div class="no-img animate-in" data-animation="fly-in-left"><?php echo htmlspecialchars_decode($description_txt); ?></div>	
										<?php endif; ?>							
									</td>
								</tr>	
							</table>
							...
							<table width="90%" border="0" cellpadding="0" cellspacing="0" >
								<tr>
									<td align="left">
										...
										<br><br><br><br>
										<div <div class="animate-in" data-animation="fly-in-left"><?php echo htmlspecialchars_decode($list_txt); ?></div>
									</td>
								</tr>	
							</table>
						</div>					
								...
								<table width="98%" border="0" cellpadding="0" cellspacing="0" >
									<tr>
										<td align="center">
											...
											<div class="centerer">
												<table border="0" cellpadding="0" cellspacing="0" width="100%" style="vertical-align:middle; width:100%">
													<tr>
													    <td valign="center">
															<div class="sx">
																<div class="sx1">
